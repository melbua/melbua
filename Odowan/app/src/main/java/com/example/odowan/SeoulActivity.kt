...
class SeoulActivity : AppCompatActivity() {
    ...
    private fun initRecycler() {
        ...
        datas.apply {
            add(LocationData(img = R.drawable.namsan, name = "태양공원", location = "양천구"))
            add(LocationData(img = R.drawable.everland, name = "바닥공원", location = "금천구"))
            add(LocationData(img = R.drawable.namsan, name = "인공공원", location = "종로구"))
            ...
            add(LocationData(img = R.drawable.everland, name = "호수공원", location = "서구"))
